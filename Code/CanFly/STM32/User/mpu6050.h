...
#define G					  9.7920f		      	// m/s^2	
#define RadtoDeg    57.324841f				//弧度到角度 (弧度 * 180/3.1415)
#define DegtoRad    0.0174533f				//角度到弧度 (角度 * 3.1415/180)

uint8_t MPU_Config(void);
uint8_t mpu_write(uint8_t addr,uint8_t reg,uint8_t len,uint8_t *buf);//IIC连续写
uint8_t mpu_read(uint8_t addr,uint8_t reg,uint8_t len,uint8_t *buf); //IIC连续读 
